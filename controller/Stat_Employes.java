...
public class Fen5_Gest_StatEmp extends JFrame {
    ...
    String[] entetes1 = {"Nom", "Prénom", "Salaire", "FonctionSexe", "Sexe", "Age"};
	...
	public Fen5_Gest_StatEmp(Magasin m) {
	    ...
	    for(int i = 0; i < m.listEmp.size(); i++) {
	    	...
	    	temp[2] = String.valueOf((((Employe) (m.listEmp.toArray()[i])).getSalaire()));
	    	temp[3] = ((Employe) (m.listEmp.toArray()[i])).getFonction();
	    	temp[4] = ((Employe) (m.listEmp.toArray()[i])).getSexe();
