...
public class Magasin implements Serializable {
    ...
    // Lister les commandes enregistr√©es 
    ...
    // Recherche d'une dÈpense par son id 
    ...
    // Recherche d'une dÈpense par sa description
    ...
    // Obtenir la valeur de la dÈpense totale d'un magasin
    ...
    // Recherche d'un client par son nom et prÈnom
    ...
    // Liste des clients possÈdant la mÍme date de crÈation de compte
    ...
    // Recherche d'un employ√© par son id, nom et pr√©nom
    ...
    // Liste de tous les employ√©s ayant le m√™me poste
    ...
    //Calcul age moyen des employ√©s d'un magasin
    ...
    //	Somme des salaires des employ√©s d'un magasin
    ...
    // Liste de tous les employ√©s ayant le m√™me salaire
